...
namespace PCMgr.WorkWindow
{
    public partial class FormAbout : Form
    {
        ...
        private void FormAbout_Load(object sender, EventArgs e)
        {
            ...
            string aboutPage;
            if (Lanuages.LanuageMgr.CurrentLanuage != null && Lanuages.LanuageMgr.CurrentLanuage.StartsWith("ja", StringComparison.OrdinalIgnoreCase))
                aboutPage = Properties.Resources.ResourceManager.GetString("PageAboutJa");
            else
                aboutPage = Lanuages.LanuageMgr.IsChinese ? Properties.Resources.PageAbout : Properties.Resources.PageAboutEn;
            if (string.IsNullOrEmpty(aboutPage))
                aboutPage = Properties.Resources.PageAboutEn;
            webBrowser1.Document.Write(aboutPage);
